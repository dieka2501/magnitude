...
<head>
    ...
    <link href="{{Config('app.url')}}public/css/plugins/iCheck/custom.css" rel="stylesheet">
    <link href="{{Config('app.url')}}public/css/animate.css" rel="stylesheet">
    <link href="{{Config('app.url')}}public/css/style.css" rel="stylesheet"> -->
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="/public/img/ibt.jpg">
                                </a>
