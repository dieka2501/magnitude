<ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="" src="{!!config('app.url')!!}public/img/ibt.jpg" width="100"  />
                             </span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">{!!$username!!}</strong>
                             </span> <span class="text-muted text-xs block">Valid Until {!!$date_exp!!} </span> </span> </a>
                ...
                <li>
                    <a href="{!!config('app.url')!!}public/admin"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards Admin</span> </a>
