    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" method="POST" action="/admin/seller/edit/{{$id}}">
                	<input type='hidden' name="_token" value="{{csrf_token()}}">
                    <div class="form-group"><label class="col-sm-2 control-label">Nama Lengkap</label>

                        <div class="col-sm-10"><input type="text" class="form-control" name='nama' id='nama' value="{{$nama}}"></div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Zipcode</label>
                        ...
                        <div class="col-lg-10"><input type="text" placeholder="" class="form-control" name="zipcode" id="zipcode" value="{{$zipcode}}"></div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group"><label class="col-lg-2 control-label">Email</label>

                        <div class="col-lg-10"><input type="email" placeholder="" class="form-control" name="email" id="email" value="{{$email}}" readonly=""></div>
                    </div>
                    <div class="form-group"><label class="col-lg-2 control-label">Phone</label>

                        <div class="col-lg-10"><input type="text" placeholder="" class="form-control" name="phone" id="phone" value="{{$phone}}"></div>
                    </div>
